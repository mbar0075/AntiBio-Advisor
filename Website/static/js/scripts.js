    ...
    <div class="ChatItem ChatItem--expert temporaryChoices">
        ...
        <div class="ChatItem-chatContent">
                <div class="ChatSelection ChatItem-chatText"
                    onclick="selectChoice('Hello, I\'m not feeling well.')">
                    Hello, I'm not feeling well.
                </div>
                <div class="ChatSelection ChatItem-chatText"
                    onclick="selectChoice('Do I need to take antibiotics?')">
                    Do I need to take antibiotics?
                </div>
                <div id="example-message" class="ChatSelection ChatItem-chatText"
                    onclick="selectChoice('What does Antimicrobial Resistance mean?')">
                    What does Antimicrobial Resistance mean?
                </div>
                <div class="ChatSelection ChatItem-chatText"
                    onclick="selectChoice('I need information about the antibiotics prescribed for my child.')">
                    I need information about the antibiotics prescribed for my child.
                </div>
            </div>
        </div>
    </div>`
